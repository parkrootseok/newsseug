...
public enum ErrorCode {
    ...
    ALREADY_EXIST_REACTION(HttpStatus.NOT_FOUND, ALREADY_EXIST_REACTION_MESSAGE),
     ...
     */
    REQUIRED_LOGIN(HttpStatus.UNAUTHORIZED, REQUIRED_LOGIN_MESSAGE),
    ...
    NOT_EXIST_REACTION(HttpStatus.NOT_FOUND, NOT_EXIST_REACTION_MESSAGE),
